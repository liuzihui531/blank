                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-inline" method="get">
                            <input type="text" name="mobile" value="<?php echo Yii::app()->request->getParam('mobile', '') ?>" class="input-medium" placeholder="联系方式">
                    ...
                    <tbody>
                        <?php foreach ($model as $k => $v): ?>
                            <tr>
                                ...
                                <td><?php echo Soil::model()->getBindKv($v->is_bind); ?></td>
