                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-inline" method="get">
                            <input type="text" name="soil_sn" value="<?php echo Yii::app()->request->getParam('soil_sn', '') ?>" class="input-medium" placeholder="地块编号">
                    ...
                    <tbody>
                        <?php foreach ($model as $k => $v): ?>
                            <tr>
                                ...
                                <td><?php echo $v->id ?></td>
                                <td><?php echo $v->soil_id ?></td>
                                <td><?php echo $v->soil_sn ?></td>
                                <td><?php echo date('Y-m-d H:i:s', $v->shot_time) ?></td>
